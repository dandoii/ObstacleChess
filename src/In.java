...
public final class In {
    ...
    public char readChar() {
        ...
        try {
            ...
            throw new NoSuchElementException("attemporaryts to read a 'char' value from the input stream, "
    ...
    public String readString() {
        try {
            ...
            throw new NoSuchElementException("attemporaryts to read a 'String' value from the input stream, "
                    + "but no more tokens are available");
        }
    }
    ...
    public int readInt() {
        try {
            ...
            throw new InputMismatchException("attemporaryts to read an 'int' value from the input stream, "
                    + "but the next token is \"" + token + "\"");
        }
        catch (NoSuchElementException e) {
            throw new NoSuchElementException("attemporarys to read an 'int' value from the input stream, "
                    + "but no more tokens are available");
        }
    }
    ...
    public double readDouble() {
        try {
            ...
            String token = scanner.next();
            throw new InputMismatchException("attemporaryts to read a 'double' value from the input stream, "
                    + "but the next token is \"" + token + "\"");
        }
        catch (NoSuchElementException e) {
            throw new NoSuchElementException("attemporarys to read a 'double' value from the input stream, "
                    + "but no more tokens are available");
        }
    }
    ...
    public float readFloat() {
        try {
            ...
            String token = scanner.next();
            throw new InputMismatchException("attemporaryts to read a 'float' value from the input stream, "
                    + "but the next token is \"" + token + "\"");
        }
        catch (NoSuchElementException e) {
            throw new NoSuchElementException("attemporarys to read a 'float' value from the input stream, "
                    + "but no more tokens are available");
        }
    }
    ...
    public long readLong() {
        try {
            ...
            String token = scanner.next();
            throw new InputMismatchException("attemporaryts to read a 'long' value from the input stream, "
                    + "but the next token is \"" + token + "\"");
        }
        catch (NoSuchElementException e) {
            throw new NoSuchElementException("attemporarys to read a 'long' value from the input stream, "
                    + "but no more tokens are available");
        }
    }
    ...
    public short readShort() {
        try {
            ...
            String token = scanner.next();
            throw new InputMismatchException("attemporaryts to read a 'short' value from the input stream, "
                    + "but the next token is \"" + token + "\"");
        }
        catch (NoSuchElementException e) {
            throw new NoSuchElementException("attemporarys to read a 'short' value from the input stream, "
                    + "but no more tokens are available");
        }
    }
    ...
    public byte readByte() {
        try {
            ...
            String token = scanner.next();
            throw new InputMismatchException("attemporaryts to read a 'byte' value from the input stream, "
                    + "but the next token is \"" + token + "\"");
        }
        catch (NoSuchElementException e) {
            throw new NoSuchElementException("attemporarys to read a 'byte' value from the input stream, "
                    + "but no more tokens are available");
        }
    }
    ...
    public boolean readBoolean() {
        try {
            ...
            throw new InputMismatchException("attemporaryts to read a 'boolean' value from the input stream, "
                    + "but the next token is \"" + token + "\"");
        }
        catch (NoSuchElementException e) {
            throw new NoSuchElementException("attemporaryts to read a 'boolean' value from the input stream, "
                    + "but no more tokens are available");
        }
    }
